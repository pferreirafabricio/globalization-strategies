...
function Invoke-MigrationCommands {
    ...
    $startupDirectory = "$PSScriptRoot/GlobalizationApiSql.csproj"
    $projectDirectory = "$PSScriptRoot/GlobalizationApiSql.csproj"
    $outputDir = "$PSScriptRoot/Database/Migrations"
